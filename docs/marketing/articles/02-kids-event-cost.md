...
- **キッズライセンスパークとエア遊具は、連日開催で2日目以降が機材費の50%（目安）**。土日2日間の開催なら、1日分の1.5倍が目安になります。ワークショップ（ぷにラボ・シールデコ）は材料を日ごとに使うため日数分となります。
...
<!-- 決定（2026-09-07）: 2日目以降50%はキッズライセンスパークとエア遊具のみ。ワークショップは対象外。本文に反映済み。 -->
